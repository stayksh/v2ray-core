...
- 🚀 兼容所有HTTP/SOCKS5代理协议，v2ray-core零配置接入
- 🌐 覆盖190+国家，城市级定位精准采集
- 💰 新用户充值加赠20%流量
...
- 🔥 Perfect for v2ray-core integration, one-line integration
...
- 🔥 Optimized for v2ray-core architecture, supports thousands of concurrent connections
...
- 🚀 Compatible with all HTTP/SOCKS5 protocols, zero-config for v2ray-core
